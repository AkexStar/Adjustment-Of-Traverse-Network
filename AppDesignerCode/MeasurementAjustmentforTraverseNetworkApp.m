classdef MeasurementAjustmentforTraverseNetworkApp < handle
    %
    % Usage:
    %     app.MeasurementAjustmentforTraverseNetworkApp
    ...
    properties (Constant)
        AppPathBase = {'/MeasurementAjustmentforTraverseNetwork'};
        AppClass = 'MeasurementAjustmentforTraverseNetworkApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = MeasurementAjustmentforTraverseNetworkApp()
        ...
        function startApp(obj)
            ...
            mlock;
            MeasurementAjustmentforTraverseNetworkApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'daoxianwang')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong daoxianwang
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'daoxianwang').getString, ...
            ...
            if nargout(@daoxianwang) == 0
                eval('daoxianwang');
            else
                obj.AppHandle = eval('daoxianwang');
            end
